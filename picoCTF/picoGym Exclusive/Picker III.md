...
We can read and write (overwrite) global variables with the `read_variable` and `write_variable` functions.

## Solution

Set one of the functions to `win`. For example, `getRandomNumber` to `win`.
```
==> 3
...
What is left is decoding obtained flag as we did in Picker I:
```
>>> c = '0x70 0x69 0x63 0x6f 0x43 0x54 0x46 0x7b 0x37 0x68 0x31 0x35 0x5f 0x31 0x35 0x5f 0x77 0x68 0x34 0x37 0x5f 0x77 0x33 0x5f 0x67 0x33 0x37 0x5f 0x77 0x31 0x37 0x68 0x5f 0x75 0x35 0x33 0x72 0x35 0x5f 0x31 0x6e 0x5f 0x63 0x68 0x34 0x72 0x67 0x33 0x5f 0x61 0x31 0x38 0x36 0x66 0x39 0x61 0x63 0x7d'
>>> ''.join([chr(int(x, 16)) for x in c.split()])
'picoCTF{7h15_15_wh47_w3_g37_w17h_u53r5_1n_ch4rg3_a186f9ac}'
```

So, the flag is `picoCTF{7h15_15_wh47_w3_g37_w17h_u53r5_1n_ch4rg3_a186f9ac}`.
